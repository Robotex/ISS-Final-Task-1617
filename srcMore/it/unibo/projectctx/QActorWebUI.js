 ...
 */
	...
	function connectToUnity(){
		send('i-connectToUnity(\"'+document.getElementById('ip').value+'\")');
		document.getElementById('inputArea').value += "\n" + 'connectToUnity(\"'+document.getElementById('ip').value+'\")';
	}
	
	function setStartingDistance(){
		send('i-startingDistance(\"'+document.getElementById('distance').value+'\")');
		document.getElementById('inputArea').value += "\n" + 'startingDistance(\"'+document.getElementById('distance').value+'\")';
	}
/*	
