%==============================================
% WorldTheory.pl for actor sonarhandler
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarhandler).	%%old version (deprecated)
actorobj(qatusonarhandler).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarhandler
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarhandler" ). 
...
%-------------------------------------------------
%  User static rules about sonarhandler
%------------------------------------------------- 
lastSonarData( SONARID):-retract( msg( M,EV,EMITTER,none,sonar( SONARID,TARGET,DISTANCE),N)),replaceRule( sonardata( sonar( SONARID,_,_)),sonardata( sonar( SONARID,TARGET,DISTANCE))),lastSonarData( SONARID).
