%==============================================
% WorldTheory.pl for actor rovermind
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturovermind).	%%old version (deprecated)
actorobj(qaturovermind).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor rovermind
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of rovermind" ). 
...
%-------------------------------------------------
%  User static rules about rovermind
%------------------------------------------------- 
/*
------------------------------------------------------------------------
