...
protected IEventItem event;
	...
	public void handleCurrentEvent() throws Exception {
		...
		QActorUtils.sendMsgExecInternal("sonarhandler_ctrl","memoCurrentEvent("+event.getPrologRep()+",true)");
		//QActorUtils.getQActor("sonarhandler_ctrl").memoCurrentEvent( event, true);
	}//handleCurrentEvent
